...
describe('Testeando stats...', () => {
    ...
    it('Debería devolver...', () => {
        return stats.promiseStats(validate.validateObj(urls.links(files.directorios("./test")))).then(data => {
            expect(data).toStrictEqual([{"Broken": 0, "Total": 2, "Type": "Statistics.....................................", "Unique": 2}]);
          });
      });
